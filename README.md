...
| **Verification URL**     | URL to the reCAPTCHA verification endpoint (default: `https://google.com/...`). You need to include this host in the Oracle Access Control List (ACL)  |
