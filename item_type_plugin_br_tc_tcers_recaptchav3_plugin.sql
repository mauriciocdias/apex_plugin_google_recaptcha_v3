...
/
prompt --application/shared_components/plugins/item_type/br_tc_tcers_recaptchav3_plugin
begin
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(3507433024533444377)
,p_plugin_type=>'ITEM TYPE'
,p_name=>'BR.TC.TCERS.RECAPTCHAV3_PLUGIN'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3507433261587444390)
,p_plugin_id=>wwv_flow_api.id(3507433024533444377)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3507433649056444400)
,p_plugin_id=>wwv_flow_api.id(3507433024533444377)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3507433979629444400)
,p_plugin_id=>wwv_flow_api.id(3507433024533444377)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3507434412080444401)
,p_plugin_id=>wwv_flow_api.id(3507433024533444377)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3386326524347844580)
,p_plugin_id=>wwv_flow_api.id(3507433024533444377)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3386347212167122273)
,p_plugin_id=>wwv_flow_api.id(3507433024533444377)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3386354096870335574)
,p_plugin_id=>wwv_flow_api.id(3507433024533444377)
,p_attribute_scope=>'APPLICATION'
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3386298420360094667)
,p_plugin_id=>wwv_flow_api.id(3507433024533444377)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3386299988837099977)
,p_plugin_id=>wwv_flow_api.id(3507433024533444377)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3386302154627106372)
,p_plugin_id=>wwv_flow_api.id(3507433024533444377)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3386360336610606277)
,p_plugin_id=>wwv_flow_api.id(3507433024533444377)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(3386361592417608891)
,p_plugin_attribute_id=>wwv_flow_api.id(3386360336610606277)
,p_display_sequence=>10
,p_display_value=>'Inline with Field and in Notification'
,p_return_value=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(3386361937700610315)
,p_plugin_attribute_id=>wwv_flow_api.id(3386360336610606277)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(3386362382690611278)
,p_plugin_attribute_id=>wwv_flow_api.id(3386360336610606277)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(3386362797022612123)
,p_plugin_attribute_id=>wwv_flow_api.id(3386360336610606277)
,p_display_sequence=>40
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(3386358189072598958)
,p_plugin_id=>wwv_flow_api.id(3507433024533444377)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>5
,p_display_sequence=>50
